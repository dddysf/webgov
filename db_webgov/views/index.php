        ...
        <div class="collapse navbar-collapse navbar-ex1-collapse">
          <ul class="nav navbar-nav side-nav">
            ...
            <li class="dropdown">
			  ...
			  <li><a href="?page=layanan">Informasi Publik</a></li>
			  <li><a href="?page=layanan">Pengaduan Publik</a></li> 
              </ul>
            </li>	
          </ul>
          ...
          <ul class="nav navbar-nav navbar-right navbar-user">
            <li class="dropdown user-dropdown">
              <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i class="fa fa-user"></i> Rafidan <b class="caret"></b></a>
              <ul class="dropdown-menu">
